...
#if FK_YAML_MAJOR_VERSION != 0 || FK_YAML_MINOR_VERSION != 3 || FK_YAML_PATCH_VERSION != 8
...
#define FK_YAML_PATCH_VERSION 8
...
inline void from_node(const BasicNodeType& n, IntegerType& i) {
    ...
    if (tmp_int < static_cast<node_int_type>(std::numeric_limits<IntegerType>::lowest())) {
